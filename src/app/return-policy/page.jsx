    ...
    <>
      ...
      <Container className="pt-0 sm:pt-32">
        ...
        <p className="pt-4 font-display text-base">
          Autoparts OEM knows that the situation may be erratic and that,
      ...
      <Container className="pt-0 sm:pt-32">
        ...
        <p className="pt-4 font-display text-base">
          At Autoparts OEM, we stake our name on the high caliber of our
        ...
        <p className="pt-4 font-display text-base">
          Please be aware that Autoparts OEM does not accept
      ...
      <Container className="pt-0 sm:pt-32">
        ...
        <p className="pt-4 font-display text-base">
          Our goal at Autoparts OEM is to make every customer experience
