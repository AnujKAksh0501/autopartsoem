    ...
    <>
      ...
      <Container className="pt-0 sm:pt-32">
        ...
        <p className="pt-4 font-display text-base">
          Welcome to Autoparts OEM, where we bring a world of
      ...
      <Container className="pt-0 sm:pt-32">
        ...
        <p className="pt-4 font-display text-base">
          Disclaimer: Autoparts OEM reserves the right to update this
      ...
      <Container className="pt-0 sm:pt-32">
        ...
        <p className="pt-4 font-display text-base">
          At Autoparts OEM, we take pride in our efficient order-handling
        ...
        <p className="pt-4 font-display text-base">
          ...
          other aspect of your Autoparts OEM experience. We remain
      ...
      <Container className="pt-0 sm:pt-32">
        ...
        <p className="pt-4 font-display text-base">
          All items purchased from Autoparts OEM are handled under our
        ...
        <p className="pt-4 font-display text-base">
          Autoparts OEM, your satisfaction is our priority. Our dedicated
        ...
        <p className="pt-4 font-display text-base">
          Thank you for choosing Autoparts OEM for all your auto parts
          needs.
        </p>
      </Container>
      <ContactSection />
