  ...
  return (
    <Section title="Customer Satisfaction Is Our Goal" image={{ src: wheels }}>
      <div className="space-y-6 text-base text-neutral-600">
        <p>
          At Autoparts OEM, used engine warranty is restricted to only
          ...
          Autoparts OEM warranty doesn&apos;t cover any attached
        ...
        <p>
          Autoparts OEM is also not accountable for any charges
        ...
        <p>
          ...
          unless the replacement is authorized by Autoparts OEM during
    ...
    <Section title="" image={{ src: gearStick, shape: 1 }}>
      <div className="space-y-6 text-base text-neutral-600">
        ...
        <p>
          ...
          or parts that were not diagnosed correctly. Autoparts OEM will
    ...
    <Section title="" image={{ src: engineRepair, shape: 2 }}>
      <div className="space-y-6 text-base text-neutral-600">
        <p>
          ...
          Autoparts OEM is using a VIN compatibility tool to assure that
        ...
        <p>
          ...
          disassembled or altered in any way without Autoparts OEM
      ...
      <Container className="mt-24">
        <GridList>
          ...
          <GridListItem className="flex" title="">
            ...
            us. Autoparts OEM warranty claim representative will work
          ...
          <GridListItem className="flex" title="">
            Autoparts OEM permits only original purchasers for any deal
  ...
  return (
    <div className="relative mt-24 pt-24 sm:mt-32 sm:pt-32 lg:mt-40 lg:pt-40">
      ...
      <SectionIntro
        ...
        title="Autoparts OEM warranty applies to the used engines ONLY."
      >
      ...
      <Container className="mt-24">
        <GridList>
          ...
          <GridListItem className="flex" title="7 ">
            Autoparts OEM warranty does not apply for an initial
            installation. Autoparts OEM warranty claim must be submitted
    ...
    <>
      ...
      <Container className="pt-0 sm:pt-32">
        ...
        <p className="pt-4 font-display text-base">
          At Autoparts OEM, our products are more than just auto parts;
        ...
        <p className="pt-4 font-display text-base">
          ...
          clearly reflected in Autoparts OEM warranty policy. We continue
        ...
        <p className="pt-4 font-display text-base">
          Autoparts OEM recognizes the value of backing up our products
          ...
          Autoparts OEM to explore the auto parts world confidently. We
      ...
      <Container className="pt-0 sm:pt-32">
        ...
        <p className="pt-4 font-display text-base">
          ...
          engine into motion. Autoparts OEM recognizes the importance of
      ...
      <div className="mt-12 flex justify-center border-t border-t-neutral-200 pt-36">
        <div className="max-w-5xl px-8 text-center">
          ...
          <p className="py-2">
            Subject to the limitations listed below, Autoparts OEM says they will
          ...
          <p className="py-2">
            Autoparts OEM will not be responsible for any labour cost incurred by
      ...
      <Container className="mt-12 flex justify-start pt-36">
        <div>
          ...
          <p className="py-2">
            The Autoparts OEM liability is solely and exclusively limited to
            ...
            consequential damages. Autoparts OEM is not responsible for any
          ...
          <p className="py-2">
            Autoparts OEM offers an extensive engine warranty regardless of the
